...
[Live Deployed Link](https://successrate.netlify.app)
...
3. the ip for the call back is https://successrate.netlify.app/.netlify/functions/netlifystockfyersbridge/api/fyerscallback as 
      of Updated : Updated date 15 Jun 2025 with following details and Permissions 
	App type: User App  	Webhook count:0 	App ID:V8BNUWJ4WQ-100
        Secret ID:KOA61TZLP4	
	Permissions:
...
https://successrate.netlify.app/.netlify/functions/fyersticker?ticker=SENSEX
...
https://successrate.netlify.app/fyersticker?userId=123&roomId=456
